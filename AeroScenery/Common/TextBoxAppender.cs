...
{
    /// <summary>
    /// From https://github.com/JeffBelback/WindowsFormsLog4NetAppenderExample
    /// </summary>
    public class TextBoxAppender : IAppender
    {
        ...
        public void DoAppend(log4net.Core.LoggingEvent loggingEvent)
        {
            try
            {
                ...
                msg = String.Format("{0} ({1}) {2}", loggingEvent.TimeStamp.ToString("yyyy-MM-dd HH:mm:ss"), loggingEvent.Level, msg);
