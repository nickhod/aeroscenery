...
{
    /// <summary>
    /// Generic orthophoto source calcuations.
    /// Based on Google's API, but may need additional paramters in the future that Google doesn't require
    /// </summary>
    public class GenericOrthophotoTileHelper
    {
